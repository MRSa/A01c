...
class PushedButton7 implements IPushedButton
{
    private final ICameraFeatureDispatcher dispatcher;
    PushedButton7(ICameraFeatureDispatcher dispatcher)
    {
    ...
    public boolean pushedButton(boolean isLongClick)
    {
        ...
        String preference_action_id = ICameraFeatureDispatcher.ACTION_BUTTON7;
        if (isLongClick)
        {
        ...
        return (dispatcher.dispatchAction(IShowInformation.BUTTON_7, preference_action_id, defaultAction));
    }
}
