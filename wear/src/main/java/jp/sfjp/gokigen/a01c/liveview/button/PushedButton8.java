...
class PushedButton8 implements IPushedButton
{
    private final ICameraFeatureDispatcher dispatcher;
    PushedButton8(ICameraFeatureDispatcher dispatcher)
    {
    ...
    public boolean pushedButton(boolean isLongClick)
    {
        ...
        String preference_action_id = ICameraFeatureDispatcher.ACTION_BUTTON8;
        if (isLongClick)
        {
        ...
        return (dispatcher.dispatchAction(IShowInformation.BUTTON_8, preference_action_id, defaultAction));
    }
}
